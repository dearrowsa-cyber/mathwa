...
const TestimonialSection = () => {
  ...
  const testimonials = [
    ...
    { id: 3, name: 'محمد العتيبي', role: 'طالب خدمة', content: 'شكراً جزيلاً لجمعية مثوى على وقفتهم ودعمهم الدائم. الخدمات ممتازة جداً ويقدمونها بكل كرامة واحترام لنا.', rating: 5 },
    ...
    { id: 7, name: 'خالد العنزي', role: 'طالب خدمة', content: 'لمست فيهم الاهتمام الصادق والرعاية المستمرة. بارك الله في جهود المتبرعين والعاملين، فهذا العمل يثلج الصدر.', rating: 5 },
    ...
    <div className="bg-gradient-to-b from-white to-emerald-50 py-16 overflow-hidden relative">
      ...
      <div className="text-center mb-12 px-4">
        ...
        <p className="text-gray-500 mt-4 text-lg">
          {isArabic ? 'ما يقوله طالبو الخدمة والمتطوعون عن جمعية مثوى' : 'What people and volunteers say about Mathwaa'}
        </p>
      </div>
