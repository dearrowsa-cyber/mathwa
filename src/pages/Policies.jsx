...
const Policies = () => {
  ...
  const policies = [
...

    {
      ...
      icon: FaBullhorn,
      color: '#0891b2',
      title_ar: 'سياسة الإفصاح والشفافية',
      title_en: 'Disclosure and Transparency Policy',
      desc_ar: 'تحدد التزام الجمعية بنشر المعلومات والتقارير المالية والأدائية للجمهور بشفافية تامة.',
      desc_en: 'Defines the association\'s commitment to publishing financial and performance information and reports to the public with full transparency.',
      pdf: '/docs/All-Policies.pdf',
      provisions_ar: [
        'نشر القوائم المالية السنوية وتقارير الأداء',
        'توفير المعلومات الأساسية للمتبرعين والداعمين',
        'الإفصاح عن أسماء أعضاء مجلس الإدارة والإدارة التنفيذية',
        'تحديث بيانات الجمعية بشكل دوري على الموقع الإلكتروني',
      ],
      provisions_en: [
        'Publishing annual financial statements and performance reports',
        'Providing basic information to donors and supporters',
        'Disclosing the names of Board members and Executive Management',
        'Periodically updating association data on the website',
      ],
    },
    {
      id: 'partners',
      icon: FaHandsHelping,
      color: '#c026d3',
      title_ar: 'سياسة التعامل مع الشركاء المنفذين',
      title_en: 'Implementing Partners Policy',
      desc_ar: 'تنظم العلاقة مع الأطراف الثالثة والشركاء المنفذين بما يضمن جودة تنفيذ البرامج وتحقيق الأهداف المشتركة.',
      desc_en: 'Regulates the relationship with third parties and implementing partners to ensure quality program execution and achieve common goals.',
      pdf: '/docs/All-Policies.pdf',
      provisions_ar: [
        'معايير اختيار الشركاء المنفذين وتقييمهم',
        'إبرام اتفاقيات ومذكرات تفاهم واضحة البنود',
        'متابعة وإشراف دقيق على تنفيذ البرامج المشتركة',
        'ضمان التزام الشركاء بسياسات الجمعية وتوجهاتها',
      ],
      provisions_en: [
        'Criteria for selecting and evaluating implementing partners',
        'Concluding agreements and MOUs with clear terms',
        'Close follow-up and supervision of joint program implementation',
        'Ensuring partners comply with association policies and directions',
      ],
    },
    {
      id: 'disbursement',
      ...
      color: '#059669',
      title_ar: 'سياسة الصرف للبرامج والأنشطة',
      title_en: 'Disbursement Policy',
      desc_ar: 'تضبط عمليات صرف الأموال على البرامج والمصروفات الإدارية وفق الميزانية المعتمدة وبأعلى درجات الكفاءة.',
      desc_en: 'Controls the disbursement of funds on programs and administrative expenses according to the approved budget and with maximum efficiency.',
      pdf: '/docs/All-Policies.pdf',
      provisions_ar: [
        'الالتزام بصرف التبرعات المقيدة في الأوجه المحددة لها',
        'تحديد نسب المصروفات الإدارية والعمومية وفق اللوائح',
        'توثيق جميع عمليات الصرف واعتمادها من المخولين',
        'المراجعة المالية الدورية لعمليات الصرف',
      ],
      provisions_en: [
        'Commitment to disbursing restricted donations in their designated areas',
        'Determining administrative expense ratios according to regulations',
        'Documenting all disbursement operations and approving them by authorized persons',
        'Periodic financial review of disbursement operations',
      ],
    },
    {
      id: 'rewards',
      icon: FaIdCard,
      color: '#ea580c',
      title_ar: 'سياسة المكافآت والامتيازات',
      title_en: 'Rewards and Privileges Policy',
      desc_ar: 'تحدد أسس ومعايير منح المكافآت والحوافز للعاملين والمتطوعين لتقدير الجهود المتميزة وتحفيز الأداء.',
      desc_en: 'Determines the principles and criteria for granting rewards and incentives to employees and volunteers to appreciate outstanding efforts and motivate performance.',
      pdf: '/docs/All-Policies.pdf',
      provisions_ar: [
        'ربط المكافآت بتقييم الأداء والإنجازات الفعلية',
        'معايير موضوعية وعادلة لمنح الامتيازات',
        'اعتماد المكافآت الاستثنائية من مجلس الإدارة',
        'توفير حوافز معنوية ومادية لتعزيز الانتماء',
      ],
      provisions_en: [
        'Linking rewards to performance evaluation and actual achievements',
        'Objective and fair criteria for granting privileges',
        'Approval of exceptional rewards by the Board of Directors',
        'Providing moral and material incentives to enhance loyalty',
      ],
    },
  ]
