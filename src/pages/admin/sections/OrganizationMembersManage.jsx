...
const OrganizationMembersManage = () => {
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold" style={{ color: '#0E4B33' }}>إدارة أعضاء المنظمة</h1>
        <Link
          to="/admin/about/organization-members/add"
      ...
      {loading ? (
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 text-center">
          ...
          <p className="text-gray-600 mb-4">No organization members yet</p>
          <Link
            to="/admin/about/organization-members/add"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg font-semibold text-white transition-opacity hover:opacity-90"
            style={{ backgroundColor: '#C89B3C' }}
                ...
                <tr key={member.id} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'} style={{ borderBottom: '1px solid #e5e7eb' }}>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex gap-2">
                      <Link
                        to={`/admin/about/organization-members/edit/${member.id}`}
...
export default OrganizationMembersManage
