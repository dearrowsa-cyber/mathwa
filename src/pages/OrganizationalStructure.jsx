...
const OrganizationalStructure = () => {
  ...
  const t = {
    en: {
      ...
      assembly_member: 'General Assembly Member',
      assembly_member_desc: 'Members forming the supreme authority of the association.',
    ...
    ar: {
      ...
      assembly_member: 'عضو مجلس عموم',
      assembly_member_desc: 'أعضاء الجمعية العمومية الذين يمثلون أعلى سلطة في الجمعية.',
      board: 'مجلس الإدارة',
  ...
  const orgLevels = [
    ...
    },
    {
      id: 'assembly_member',
      icon: FaUsers,
      title: t.assembly_member,
      desc: t.assembly_member_desc,
      color: '#0E4B33',
      level: 2,
    },
    {
